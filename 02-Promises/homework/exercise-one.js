...
function problemC () {
 ...
 /* readFile('poem-one/stanza-02.txt', function (err, stanza2) {
  ...
  promisifiedReadFile('poem-one/stanza-02.txt').then((stanza2)=>{
    ...
    blue(stanza2);
    return
  }).then( promisifiedReadFile('poem-one/stanza-03.txt').then((stanza3)=>{
    console.log('-- C. callback version (stanza three) --');
      blue(stanza3);
      console.log('-- C. callback version done --');
  }))
...
*/
  ...
  promisifiedReadFile('poem-one/stanza-03.txt').then((stanza3)=>{
    blue(stanza3);
    return promisifiedReadFile('poem-one/stanza-44444.txt').then((stanza4)=>{
      blue(stanza4);     
...
}).catch((err)=> magenta(new Error(err))).finally(()=>console.log("done"))
